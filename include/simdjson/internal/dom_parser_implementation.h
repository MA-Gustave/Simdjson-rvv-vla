...
public:
   ...
   */
  simdjson_pure inline size_t capacity() const noexcept;
   ...
   */
  simdjson_pure inline size_t max_depth() const noexcept;
...
simdjson_pure inline size_t dom_parser_implementation::capacity() const noexcept {
  return _capacity;
}

simdjson_pure inline size_t dom_parser_implementation::max_depth() const noexcept {
  return _max_depth;
}
