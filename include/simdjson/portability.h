...
#define SIMDJSON_IS_RISCV64 1
  ...
  // RISC-V function target regions allow a baseline rv64 binary to contain
  // RVV functions and dispatch to them only when the OS reports V support.
  #if defined(__clang__)
    #if defined(__has_attribute)
      #if __has_attribute(target)
        #define SIMDJSON_COMPILER_SUPPORTS_RVV_TARGET_REGION 1
      #endif
    #endif
...
#if defined(SIMDJSON_IS_X86_64) || defined(SIMDJSON_IS_LSX) || defined(SIMDJSON_IS_RISCV64)
#ifdef __clang__
...
#endif // SIMD target-region capable architectures

#ifndef SIMDJSON_COMPILER_SUPPORTS_RVV_TARGET_REGION
#define SIMDJSON_COMPILER_SUPPORTS_RVV_TARGET_REGION 0
#endif
