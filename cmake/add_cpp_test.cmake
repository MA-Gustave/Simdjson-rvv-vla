...
function(add_cpp_test TEST_NAME)
  ...
  if (ARGS_COMPILE_ONLY OR ARGS_LIBRARY)
    ...
    # Use the target-aware add_test signature. This lets CMake prepend the
    # target's CROSSCOMPILING_EMULATOR (qemu-riscv64 -L <sysroot>) when
    # cross-compiling, instead of handing the RISC-V ELF directly to binfmt.
